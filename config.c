...
const config default_cfg = {
  ...
  .ansi_colours = {
    ...
    [CYAN_I]         = 0x98A12A,
    [WHITE_I]        = 0xD5E8EE,
    [BOLD_BLACK_I]   = 0x362B00,
    [BOLD_RED_I]     = 0x164BCB,
    [BOLD_GREEN_I]   = 0x756E58,
    [BOLD_YELLOW_I]  = 0x837B65,
    [BOLD_BLUE_I]    = 0x969483,
    [BOLD_MAGENTA_I] = 0xC4716C,
    [BOLD_CYAN_I]    = 0xA1A193,
    [BOLD_WHITE_I]   = 0xE3F6FD,
  }
};
